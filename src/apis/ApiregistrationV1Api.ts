...
export class ApiregistrationV1Api extends runtime.BaseAPI {
     ...
     */
    async createAPIServiceRaw(requestParameters: CreateAPIServiceRequest): Promise<runtime.ApiResponse<V1APIService>> {
     ...
     */
    async listAPIServiceRaw(requestParameters: ListAPIServiceRequest): Promise<runtime.ApiResponse<V1APIServiceList>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     */
    async patchAPIServiceRaw(requestParameters: PatchAPIServiceRequest): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     */
    async patchAPIServiceStatusRaw(requestParameters: PatchAPIServiceStatusRequest): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update status of the specified APIService
     */
    async patchAPIServiceStatus(requestParameters: PatchAPIServiceStatusRequest): Promise<V1APIService> {
     ...
     */
    async readAPIServiceRaw(requestParameters: ReadAPIServiceRequest): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     */
    async readAPIServiceStatusRaw(requestParameters: ReadAPIServiceStatusRequest): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read status of the specified APIService
     */
    async readAPIServiceStatus(requestParameters: ReadAPIServiceStatusRequest): Promise<V1APIService> {
     ...
     */
    async replaceAPIServiceRaw(requestParameters: ReplaceAPIServiceRequest): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     */
    async replaceAPIServiceStatusRaw(requestParameters: ReplaceAPIServiceStatusRequest): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace status of the specified APIService
     */
    async replaceAPIServiceStatus(requestParameters: ReplaceAPIServiceStatusRequest): Promise<V1APIService> {
