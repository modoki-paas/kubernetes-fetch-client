...
export class CoordinationV1Api extends runtime.BaseAPI {
     ...
     * create a Lease
     */
    async createNamespacedLeaseRaw(requestParameters: CreateNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Lease>> {
     ...
     * create a Lease
     */
    async createNamespacedLease(requestParameters: CreateNamespacedLeaseRequest): Promise<V1Lease> {
     ...
     */
    async listLeaseForAllNamespacesRaw(requestParameters: ListLeaseForAllNamespacesRequest): Promise<runtime.ApiResponse<V1LeaseList>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * list or watch objects of kind Lease
     */
    async listLeaseForAllNamespaces(requestParameters: ListLeaseForAllNamespacesRequest): Promise<V1LeaseList> {
     ...
     * list or watch objects of kind Lease
     */
    async listNamespacedLeaseRaw(requestParameters: ListNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1LeaseList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
     ...
     * list or watch objects of kind Lease
     */
    async listNamespacedLease(requestParameters: ListNamespacedLeaseRequest): Promise<V1LeaseList> {
     ...
     */
    async patchNamespacedLeaseRaw(requestParameters: PatchNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Lease>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update the specified Lease
     */
    async patchNamespacedLease(requestParameters: PatchNamespacedLeaseRequest): Promise<V1Lease> {
     ...
     */
    async readNamespacedLeaseRaw(requestParameters: ReadNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Lease>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read the specified Lease
     */
    async readNamespacedLease(requestParameters: ReadNamespacedLeaseRequest): Promise<V1Lease> {
     ...
     */
    async replaceNamespacedLeaseRaw(requestParameters: ReplaceNamespacedLeaseRequest): Promise<runtime.ApiResponse<V1Lease>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace the specified Lease
     */
    async replaceNamespacedLease(requestParameters: ReplaceNamespacedLeaseRequest): Promise<V1Lease> {
