...
import {
    ...
    V1StatusToJSON,
    V1TokenRequest,
    V1TokenRequestFromJSON,
    V1TokenRequestToJSON,
    V1beta1Eviction,
...
export interface CreateNamespacedServiceAccountTokenRequest {
    name: string;
    namespace: string;
    body: V1TokenRequest;
    dryRun?: string;
...
export class CoreV1Api extends runtime.BaseAPI {
     ...
     */
    async createNamespacedServiceAccountTokenRaw(requestParameters: CreateNamespacedServiceAccountTokenRequest): Promise<runtime.ApiResponse<V1TokenRequest>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: V1TokenRequestToJSON(requestParameters.body),
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => V1TokenRequestFromJSON(jsonValue));
    }

    /**
     * create token of a ServiceAccount
     */
    async createNamespacedServiceAccountToken(requestParameters: CreateNamespacedServiceAccountTokenRequest): Promise<V1TokenRequest> {
