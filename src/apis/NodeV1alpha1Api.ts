...
export class NodeV1alpha1Api extends runtime.BaseAPI {
     ...
     */
    async createRuntimeClassRaw(requestParameters: CreateRuntimeClassRequest): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
     ...
     * create a RuntimeClass
     */
    async createRuntimeClass(requestParameters: CreateRuntimeClassRequest): Promise<V1alpha1RuntimeClass> {
     ...
     */
    async listRuntimeClassRaw(requestParameters: ListRuntimeClassRequest): Promise<runtime.ApiResponse<V1alpha1RuntimeClassList>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * list or watch objects of kind RuntimeClass
     */
    async listRuntimeClass(requestParameters: ListRuntimeClassRequest): Promise<V1alpha1RuntimeClassList> {
     ...
     */
    async patchRuntimeClassRaw(requestParameters: PatchRuntimeClassRequest): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update the specified RuntimeClass
     */
    async patchRuntimeClass(requestParameters: PatchRuntimeClassRequest): Promise<V1alpha1RuntimeClass> {
     ...
     */
    async readRuntimeClassRaw(requestParameters: ReadRuntimeClassRequest): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read the specified RuntimeClass
     */
    async readRuntimeClass(requestParameters: ReadRuntimeClassRequest): Promise<V1alpha1RuntimeClass> {
     ...
     */
    async replaceRuntimeClassRaw(requestParameters: ReplaceRuntimeClassRequest): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace the specified RuntimeClass
     */
    async replaceRuntimeClass(requestParameters: ReplaceRuntimeClassRequest): Promise<V1alpha1RuntimeClass> {
