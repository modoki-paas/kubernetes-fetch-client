...
import {
    ...
    V1EndpointPort,
    V1EndpointPortFromJSON,
    V1EndpointPortFromJSONTyped,
    V1EndpointPortToJSON,
} from './';
...
export function V1EndpointSubsetFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1EndpointSubset {
    ...
    return {
        ...
        'ports': !exists(json, 'ports') ? undefined : ((json['ports'] as Array<any>).map(V1EndpointPortFromJSON)),
    };
}
...
export function V1EndpointSubsetToJSON(value?: V1EndpointSubset | null): any {
    ...
    return {
        ...
        'ports': value.ports === undefined ? undefined : ((value.ports as Array<any>).map(V1EndpointPortToJSON)),
    };
}
