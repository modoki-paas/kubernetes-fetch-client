...
export function V1beta1PolicyRuleFromJSON(json: any): V1beta1PolicyRule {
    return V1beta1PolicyRuleFromJSONTyped(json, false);
}

export function V1beta1PolicyRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1PolicyRule {
...
export function V1beta1PolicyRuleToJSON(value?: V1beta1PolicyRule | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
