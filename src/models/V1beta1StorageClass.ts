...
export function V1beta1StorageClassFromJSON(json: any): V1beta1StorageClass {
    return V1beta1StorageClassFromJSONTyped(json, false);
}

export function V1beta1StorageClassFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1StorageClass {
...
export function V1beta1StorageClassToJSON(value?: V1beta1StorageClass | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
