...
export function V1beta1SubjectAccessReviewFromJSON(json: any): V1beta1SubjectAccessReview {
    return V1beta1SubjectAccessReviewFromJSONTyped(json, false);
}

export function V1beta1SubjectAccessReviewFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1SubjectAccessReview {
...
export function V1beta1SubjectAccessReviewToJSON(value?: V1beta1SubjectAccessReview | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
